    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-slate-50 dark:bg-slate-900/40 rounded-3xl p-6 border border-slate-200 dark:border-white/10 shadow-lg relative overflow-hidden group">
                    <div className="absolute -right-6 -top-6 opacity-[0.02] group-hover:opacity-[0.06] transition-opacity z-0 pointer-events-none transform rotate-12 scale-125">
                    ...
                    <div className="relative z-10 flex items-center gap-4 pointer-events-none">
                        ...
                        <div className="z-20">
                            ...
                            <p className="text-xl font-black text-slate-900 dark:text-white drop-shadow-sm">{formatCOP(totalInventoryValue)}</p>
                        </div>
                    </div>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-slate-50 dark:bg-slate-900/40 rounded-3xl p-6 border border-slate-200 dark:border-white/10 shadow-lg relative overflow-hidden group">
                    <div className="absolute -right-6 -top-6 opacity-[0.02] group-hover:opacity-[0.06] transition-opacity z-0 pointer-events-none transform rotate-12 scale-125">
                    ...
                    <div className="relative z-10 flex items-center gap-4 pointer-events-none">
                        ...
                        <div className="z-20">
                            ...
                            <p className="text-xl font-black text-slate-900 dark:text-white drop-shadow-sm">{formatCOP(totalSales)}</p>
                        </div>
                    </div>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="bg-slate-50 dark:bg-slate-900/40 rounded-3xl p-6 border border-slate-200 dark:border-white/10 shadow-lg relative overflow-hidden group">
                    <div className="absolute -right-6 -top-6 opacity-[0.02] group-hover:opacity-[0.06] transition-opacity z-0 pointer-events-none transform rotate-12 scale-125">
                    ...
                    <div className="relative z-10 flex items-center gap-4 pointer-events-none">
                        ...
                        <div className="z-20">
                            ...
                            <p className="text-xl font-black text-indigo-600 dark:text-indigo-400 drop-shadow-sm">{formatCOP(stats.netProfit || 0)}</p>
                        </div>
                    </div>
                </motion.div>
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="bg-slate-50 dark:bg-slate-900/40 rounded-3xl p-6 border border-slate-200 dark:border-white/10 shadow-lg relative overflow-hidden group">
                    <div className="absolute -right-6 -top-6 opacity-[0.02] group-hover:opacity-[0.06] transition-opacity z-0 pointer-events-none transform rotate-12 scale-125">
                    ...
                    <div className="relative z-10 flex items-center gap-4 pointer-events-none">
                        ...
                        <div className="z-20">
                            ...
                            <p className="text-xl font-black text-orange-600 dark:text-orange-400 drop-shadow-sm">{formatCOP(totalPotentialProfit)}</p>
                        </div>
                    </div>
                </motion.div>
            </div>
